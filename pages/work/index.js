...
const Work = () => {
  return (
    <div className='xl:h-full bg-primary/30 py-36 flex items-center'>
      <Circles />
      <div className='container mx-auto'>
        <div className='flex flex-col xl:flex-row gap-x-8'>
          ...
          <div className='text-center flex xl:w-[30vw] flex-col lg:text-left mb-4 xl:mb-0'>
            ...
            From interactive web applications to responsive websites, each project reflects my dedication to delivering high-quality and user-friendly solutions as a Full Stack Developer.
            </motion.p>
          </div>
